...
၃။ Environment variable တွေ ဖြည့်ပါ —
   ...
   | `CORS_ORIGINS` | `https://placeholder.vercel.app` — ယာယီတန်ဖိုး၊ အဆင့် ၄ မှာ အစားထိုးမယ် |

   `SECRET_KEY` ကို Render က အလိုအလျောက် ထုတ်ပေးပါတယ်။ **သင်မဖြည့်ပါနဲ့။**

   ⚠️ ယာယီတန်ဖိုး ထည့်ရတာက အကြောင်းရှိပါတယ် — `CORS_ORIGINS` ဗလာဖြစ်နေရင်
   app က စတင်မှာမဟုတ်ပါဘူး။ ဒါပေမဲ့ frontend URL အစစ်က မရှိသေးပါဘူး။
   ဒါကြောင့် ယာယီတစ်ခုထည့်ပြီး အဆင့် ၄ မှာ အစားထိုးရပါမယ်။

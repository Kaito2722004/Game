...
export function Dialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
      ...
      >
        <header className="flex items-start justify-between gap-4 border-b border-lab-200 px-5 py-4">
          <div>
          ...
          <button
            ...
            className="rounded-lg p-1 text-lab-400 transition-colors hover:bg-lab-100 hover:text-lab-700"
          >
        ...
        {footer ? (
          <footer className="flex justify-end gap-2 border-t border-lab-200 px-5 py-4">
            {footer}
          </footer>
        ) : null}
      </div>
